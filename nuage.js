var newExplosion = function(x,y,tx,ty,s,color,n){
    ...
    var random = 1;
    var v = 0;
    var colorset = [["rgba(229,179,24,1);rgba(150,35,38,1);rgba(150,35,38,0)","rgba(216,140,28,1);rgba(119,35,40,1);rgba(119,35,40,0)"],["rgba(50,50,50,1);rgba(0,0,0,1);rgba(0,0,0,0)","rgba(255,255,255,1);rgba(200,200,200,1);rgba(200,200,200,0)"],["rgba(107,30,136,1);rgba(42,12,54,1);rgba(42,12,54,0)","rgba(32,153,203,1);rgba(20,98,130,1);rgba(20,98,130,0)"]];
